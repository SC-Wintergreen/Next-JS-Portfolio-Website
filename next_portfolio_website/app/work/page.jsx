        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          <div className="w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none">
            <div className="flex flex-col gap-[30px] h-[50%]">
              <div className="text-5xl  font-bold ">{project.num}</div>
              <h2 className="text-[42] font-bold leading-none text-white group-hover:text-accent transition-all duration-500 capitalize">
                {project.category}
              </h2>
                ...
                <Link href={project.github}>
                  <TooltipProvider delayDuration={100}>
                    <Tooltip>
                      ...
                      <TooltipContent>Github Repo Link</TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </Link>
              </div>
